...
class AccessoryFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                MaterialTheme {
                    val accessories by mAccessoryViewModel!!.allAccessories.observeAsState(initial = emptyList())
                    
                    AccessoryListScreen(
                        accessories = accessories,
                        onItemClick = { mListener?.onListFragmentInteraction(Accessory.fromEntity(it), false) },
                        onItemLongClick = { mListener?.onListFragmentInteraction(Accessory.fromEntity(it), true) },
