...
public class MyLensRecyclerViewAdapter extends RecyclerView.Adapter<MyLensRecyclerViewAdapter.ViewHolder> {

    //private final List<DummyItem> mValues;
    private final ArrayList<LensSpec> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyLensRecyclerViewAdapter(ArrayList<LensSpec> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
